public class Main {
    public static void main(String[] args) {
        ...
        Exam exam1 = new Exam(1, "Midterm", 40, 88);
        Exam exam2 = new Exam(2, "Final", 50, 92);
        Assignment assignment1 = new Assignment(1, "Homework 1", 10, 20, 20);
        ...
        Exam exam3 = new Exam(3, "Midterm", 40, 83);
        Exam exam4 = new Exam(4, "Final", 50, 86);
        Assignment assignment3 = new Assignment(3, "Homework 1", 10, 18, 20);
